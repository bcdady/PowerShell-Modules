...
function Enter-XASession {
    # For automating user session setup / maintenance tasks from within Citrix XenApp context
                # Sync files
            ...
            # if ($env:ComputerName -ne 'GC91IT78') {
                # Determine client (Receiver) location on the network, and check/set default printer
                # based on IP address ranges for common IT locations
